...
# ==========================================
# الإصلاح الجذري لمشكلة الـ Sliders مع اللغة العربية
# ==========================================
st.markdown("""
    <style>
    /* 1. إجبار التطبيق بالكامل على اتجاه (اليسار-لليمين) لإنقاذ الجافاسكريبت */
    html, body, .stApp {
        direction: ltr !important;
    }
    
    /* 2. استهداف العناوين والنصوص العادية عشان تظهر عربي من اليمين بشكل سليم */
    h1, h2, h3, p {
        direction: rtl !important;
        text-align: right !important;
    }
    
    /* 3. استثناء الـ Sliders وعناوينها الإنجليزية عشان تفضل شغالة يسار-يمين مظبوط */
    [data-testid="stSlider"], [data-testid="stSlider"] p, [data-testid="stSlider"] div {
        direction: ltr !important;
        text-align: left !important;
    }
    
    /* 4. تظبيط صناديق الإدخال (Inputs) لتظل متناسقة */
    .stNumberInput p, .stSelectbox p {
        direction: ltr !important;
        text-align: left !important;
    }
    </style>
