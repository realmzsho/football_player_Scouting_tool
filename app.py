...
with tab_classifier:
    ...
    st.markdown("أدخل إحصائيات اللاعب التفصيلية، وسيقوم الذكاء الاصطناعي بتوقع **أفضل مركز** له في الملعب.")
    ...
    def load_models():
        try:
            ...
            st.error("⚠️ يرجى التأكد من وجود ملفات (scaler.pkl, pca_final.pkl, xgb_model.pkl, label_encoder.pkl) في نفس المسار.")
            st.stop()
